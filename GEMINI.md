...
- Anchor does not redistribute ISO 20022 specifications. Users supply their own
  catalogue; Anchor embeds only factual metadata (identifiers, versions, the
...
- Generated output must validate against its schema and pass Anchor's own
